...
class ShimmerNativeBannerAd100Activity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shimmer_native_banner_ad100)

        initializeViews()
        setAdView()

        Log.e(LOG_TAG, "${TAG}_onCreate")
        MainApplication.firebaseAnalytics?.logEvent("${TAG}_create", Bundle())
    }
    ...
    private fun setAdView() {
        if (AdsConstant.showNativeBannerShimmer100 == "yes") {
...
//                tvAdText.visibility = View.GONE
    ...
    companion object {
        private const val LOG_TAG = "ShimmerNativeBannerAd100Activity"
        private const val TAG = "ShimmerNTBNAd100"
    }
