...
class ShimmerNativeBannerAd130Activity : BaseActivity() {
    ...
    private val TAG = "ShimmerNativeBannerAd130Act"
    ...
    private fun googleNativeBannerAd(
        ...
        Log.e(TAG, "ShimmerNTBNAd130_LoadStart")
        ...
        val adLoader = builder.withAdListener(object : AdListener() {
            override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                Log.e(TAG, "ShimmerNTBNAd130_Fail$loadAdError")
            ...
            override fun onAdLoaded() {
                Log.e(TAG, "ShimmerNTBNAd130_Loaded")
    ...
    private fun showNativeBanner(
        ...
        Log.e(TAG, "ShimmerNTBNAd130_Show")
