...
class ShimmerNativeBannerAd80Activity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityShimmerNativeBannerAd80Binding.inflate(layoutInflater)
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                Log.e(EventLog, "ShimmerNTBNAd80_onBackPressed")
                MainApplication.firebaseAnalytics?.logEvent(
                    "ShimmerNTBNAd80_onBackPressed",
                    Bundle()
                )
        ...
        Log.e(EventLog, "ShimmerNTBNAd80_onCreate")
        MainApplication.firebaseAnalytics?.logEvent("ShimmerNTBNAd80_onCreate", Bundle())
    }
    ...
    private fun loadMoreAppNativeBannerAd(
        ...
        Log.e(EventLog, "ShimmerNTBNAd80_More_LoadStart")
        MainApplication.firebaseAnalytics?.logEvent("ShimmerNTBNAd80_More_LoadStart", Bundle())
        ...
        val bindingAd = GoogleNativeBannerAdView80CloneBinding.inflate(activity.layoutInflater)
        frameLayout.removeAllViews()
        ...
        Log.e(EventLog, "ShimmerNTBNAd80_More_Show")
        MainApplication.firebaseAnalytics?.logEvent("ShimmerNTBNAd80_More_Show", Bundle())
    }
